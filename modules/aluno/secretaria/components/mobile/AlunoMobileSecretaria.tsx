    ...
    <div className="space-y-4 md:hidden">
      ...
      {section === 'servicos' ? (
        <section className="space-y-3" aria-labelledby="mobile-secretaria-services-title">
          ...
          <button type="button" onClick={() => { setSection('solicitacoes'); setShowNewRequest(true); }} className="flex min-h-14 w-full items-center justify-between rounded-[1.35rem] bg-[#001a33] px-4 text-left text-white shadow-sm active:bg-slate-900">
