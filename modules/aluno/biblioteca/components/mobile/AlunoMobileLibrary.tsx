...
const AlunoMobileLibrary = ({
  ...
  return (
    <div className="space-y-4 md:hidden">
      ...
      {isError ? (
        <div role="alert" className="flex min-h-48 flex-col items-center justify-center rounded-[1.5rem] border border-amber-200 bg-amber-50 p-6 text-center shadow-sm">
          <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white text-amber-600 shadow-sm"><AlertTriangle size={22} /></span>
          <h2 className="mt-4 text-sm font-black text-[#001a33]">Não foi possível carregar o acervo</h2>
          <p className="mt-1 max-w-xs text-[11px] font-medium leading-relaxed text-slate-600">Verifique sua conexão e tente novamente. Nenhum resultado vazio foi assumido.</p>
          <button type="button" onClick={onRetry} className="mt-4 flex min-h-11 items-center justify-center gap-2 rounded-xl bg-[#001a33] px-4 text-[10px] font-black uppercase tracking-wide text-white">
