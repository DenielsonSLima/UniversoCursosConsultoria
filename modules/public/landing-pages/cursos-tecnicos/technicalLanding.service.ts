...
const mapTurma = (row: any): TechnicalLandingClass => ({
  ...
  punctualDiscount: Number(row.desconto_pontualidade || 0),
  punctualDiscountEnabled: row.aplicar_desconto_mensalidade === true,
  punctualInstallmentValue: Number(row.valor_parcela_com_desconto ?? row.valor_parcela ?? 0),
