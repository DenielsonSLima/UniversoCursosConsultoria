...
export const PUBLIC_VALIDATION_FIELD_CATALOG: readonly PublicValidationFieldDefinition[] = [
  { id: 'studentName', label: 'Nome do estudante (mascarado)', description: 'Primeiro nome legível e demais nomes protegidos.', group: 'Identificação', risk: 'sensível', masked: true },
...
export const isPublicValidationFieldCompatible = (
  ...
  documentType === 'diario_classe'
    ? DIARY_PUBLIC_FIELDS.has(field.id)
    : (
