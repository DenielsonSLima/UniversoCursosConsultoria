...
interface CursosTecnicosCardProps {
  onClick?: () => void;
}

const CursosTecnicosCard: React.FC<CursosTecnicosCardProps> = ({ onClick }) => {
  return (
    <div 
      onClick={onClick}
    ...
    >
      ...
      <div>
        ...
        <h3 className="text-lg font-bold text-white mb-1">Técnicos</h3>
        <p className="text-blue-50 text-xs font-light leading-snug opacity-90">
          Formação estratégica para profissões de alta demanda técnica.
        </p>
      </div>
...
export default CursosTecnicosCard;
