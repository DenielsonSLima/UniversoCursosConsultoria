...
interface EspecializacaoTecnicaCardProps {
  onClick?: () => void;
}

const EspecializacaoTecnicaCard: React.FC<EspecializacaoTecnicaCardProps> = ({ onClick }) => {
  return (
    <div 
      onClick={onClick}
    ...
    >
      ...
      <div>
        ...
        <h3 className="text-lg font-bold text-white mb-1">Especialização</h3>
        <p className="text-blue-50 text-xs font-light leading-snug opacity-90">
          Aprofunde seus conhecimentos técnicos com foco em alta performance.
        </p>
      </div>
...
export default EspecializacaoTecnicaCard;
