  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <h3 className="text-lg font-bold text-white mb-1">Superior</h3>
        <p className="text-blue-50 text-xs font-light leading-snug opacity-90">
          Graduações e pós-graduações que transformarão seu futuro profissional.
        </p>
      </div>
...
export default EnsinoSuperiorCard;
