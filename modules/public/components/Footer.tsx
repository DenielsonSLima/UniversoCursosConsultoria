    ...
    <footer className="bg-[#001a33] text-white pt-20 pb-8 border-t border-white/5">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          {/* Links Rápidos */}
          <div>
            <h4 className="text-xs font-black uppercase tracking-[0.2em] text-blue-400 mb-4">Navegação</h4>
            <ul className="space-y-2 text-slate-400 text-sm font-bold uppercase leading-snug tracking-widest">
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center text-[10px] text-slate-500 uppercase tracking-[0.2em] font-bold text-center md:text-left gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-end gap-x-7 gap-y-3">
            ...
            <button onClick={() => navigate('/cookies')} className="hover:text-white transition-colors">Política de Cookies</button>
          </div>
        </div>
      </div>
    </footer>
