...
type TurnstileAction = 'login' | 'recover' | 'signup' | 'support';
    ...
    const renderWidget = async () => {
      ...
      try {
        ...
        widgetIdRef.current = turnstile.render(containerRef.current, {
          ...
          // imediato ao usuário, isso garante que um desafio interativo não fique
          // oculto quando o Cloudflare elevar a verificação de risco.
          appearance: 'always',
          retry: 'auto',
