// File: modules/gestor/configuracoes/assinaturas/AssinaturasConfig.tsx
...
const AssinaturasConfig: React.FC = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      // getSignatures() agora busca do Supabase como fonte primária
  ...
  const renderSignatureInput = (role: keyof AssinaturasData, title: string) => {
