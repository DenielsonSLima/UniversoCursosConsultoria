...
const WIDGET_OPTIONS: Array<{
...
}> = [
  {
    id: 'alunos-ativos',
    label: 'Alunos ativos',
    description: 'Quantidade canônica de alunos ativos retornada pelo backend.',
  ...
  },
  {
    ...
    description: 'Quantidade canônica de novas matrículas retornada pelo backend.',
    requirement: 'Parceiros, Gestão (Resumo/Alunos) ou Secretaria (Busca de Aluno)',
    icon: GraduationCap,
  ...
  {
    id: 'receita-mes',
    label: 'Atalho para contas a receber',
    description: 'Exibe um acesso discreto ao resumo financeiro, sem valores na tela inicial.',
  ...
  {
    id: 'inadimplencia',
    label: 'Atalho para inadimplência',
    description: 'Indica onde consultar pendências financeiras, sem expor percentuais no início.',
    requirement: 'Financeiro: Resumo ou Contas a Receber',
    icon: AlertTriangle,
  ...
  {
    id: 'fluxo-caixa',
    label: 'Atalho para fluxo de caixa',
    description: 'Direciona ao desempenho financeiro completo, sem gráfico na página inicial.',
