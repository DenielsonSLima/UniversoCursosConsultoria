...
const DEFAULT_WHATSAPP_DRAFT: MensageriaConfigData = {
  ...
  waDueNoticeTemplate: 'Olá, {{nome_aluno}}. Passando para lembrar que sua parcela de {{valor_fatura}} vence em {{data_vencimento}}. Para facilitar, o pagamento pode ser feito por este link: {{link_pagamento}}. Se você já realizou o pagamento, por favor desconsidere esta mensagem.',
  waSendPaymentReceipt: true,
  waPaymentReceiptTemplate: 'Olá, {{nome_aluno}}. Confirmamos o recebimento do pagamento de {{valor_fatura}} referente a {{descricao_fatura}}. Obrigado por manter tudo em dia com a Universo Cursos.',
  waSendOverdueNotice: true,
  waOverdueNoticeDays: 1,
  waDefaultOverdueTemplate: 'Olá, {{nome_aluno}}. Verificamos uma parcela de {{valor_fatura}} com vencimento em {{data_vencimento}} ainda em aberto. Para regularizar, você pode usar este link: {{link_pagamento}}. Se o pagamento já foi feito, por favor desconsidere esta mensagem.',
