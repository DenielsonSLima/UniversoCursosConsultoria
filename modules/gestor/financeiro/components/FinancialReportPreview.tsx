...
const statusStyles: Record<string, string> = {
  PAGO: 'bg-emerald-50 text-emerald-700 border-emerald-200 font-bold',
  RECEBIDO: 'bg-emerald-50 text-emerald-700 border-emerald-200 font-bold',
  PENDENTE: 'bg-amber-50 text-amber-700 border-amber-200 font-bold',
  VENCIDO: 'bg-rose-50 text-rose-600 border-rose-200 font-black',
  SUSPENSO: 'bg-blue-50 text-blue-700 border-blue-200 font-bold',
  CANCELADO: 'bg-slate-100 text-slate-500 border-slate-200 font-bold',
  ESTORNADO: 'bg-slate-100 text-slate-500 border-slate-200 font-bold',
  DEVOLVIDO: 'bg-slate-100 text-slate-500 border-slate-200 font-bold',
};
