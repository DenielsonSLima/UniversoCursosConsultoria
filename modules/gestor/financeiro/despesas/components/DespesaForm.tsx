          ...
          {mode === 'parcelado' && (
            <div className="p-4 bg-indigo-50 rounded-2xl border border-indigo-100 space-y-3 md:col-span-2">
              ...
              <p className="text-[10px] text-indigo-500 font-medium">
                Serão criadas <strong>{totalParcelas}</strong> parcelas com valor-base de{' '}
                <strong>{(parseCurrencyInput(valor) || 0).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</strong>{' '}
                cada, com intervalo de <strong>{intervaloDias} {intervaloUnit}</strong>. Os ajustes acima serão aplicados em cada parcela.
              </p>
            </div>
          )}
