...
const DespesasVariaveisTab: React.FC = () => {
  return (
    <div className="p-12 text-center bg-slate-50 rounded-[2rem] border border-dashed border-slate-350 flex flex-col items-center justify-center space-y-4 animate-fadeIn">
      ...
      <div className="space-y-1">
        <h4 className="text-lg font-black text-[#001a33] uppercase tracking-tight">Despesas Variáveis</h4>
      ...
      <p className="text-slate-400 text-xs max-w-md leading-relaxed font-medium">
        Este submódulo gerenciará despesas pontuais ou variáveis da instituição, como fornecedores de materiais impressos, publicidade, serviços pontuais de TI, reparos estruturais e consultorias.
      </p>
