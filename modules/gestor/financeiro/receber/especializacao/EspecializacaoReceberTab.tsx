// File: modules/gestor/financeiro/receber/especializacao/EspecializacaoReceberTab.tsx
  ...
  return (
    <div className="p-12 text-center bg-slate-50 rounded-[2rem] border border-dashed border-slate-350 flex flex-col items-center justify-center space-y-4 animate-fadeIn">
      ...
      <div className="space-y-1">
        <h4 className="text-lg font-black text-[#001a33] uppercase tracking-tight">Especialização — Recebíveis</h4>
      ...
      <p className="text-slate-400 text-xs max-w-md leading-relaxed font-medium">
        Este submódulo gerenciará os contratos, parcelas e mensalidades referentes a turmas e alunos de pós-graduação e especializações.
      </p>
      <div className="flex items-center gap-2 text-[10px] font-black uppercase text-slate-400 bg-white border border-slate-200 px-3.5 py-1.5 rounded-full shadow-sm">
        <Hammer size={12} className="text-amber-500 animate-bounce" /> Em estruturação de banco de dados
      </div>
    </div>
  );
};
