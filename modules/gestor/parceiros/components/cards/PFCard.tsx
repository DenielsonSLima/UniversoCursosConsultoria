...
const PFCard: React.FC<PFCardProps> = ({ data, onClick, onDelete, onConfirmEmail, isConfirmingEmail }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap gap-1.5 mb-3 relative z-10">
        ...
        <span className="px-2.5 py-0.5 bg-amber-50 text-amber-600 text-[10px] font-semibold rounded-full border border-amber-100">
          Pessoa Física
        </span>
        {data.tipoServico && (
          <span className="flex items-center gap-1 px-2.5 py-0.5 bg-slate-50 text-slate-500 text-[10px] font-semibold rounded-full border border-slate-200">
      ...
      <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between relative z-10">
        ...
        <div className="flex items-center gap-1 text-[11px] font-semibold text-slate-400 group-hover:text-amber-600 transition-colors">
