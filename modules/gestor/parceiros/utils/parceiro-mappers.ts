...
export function toCamel(s: any) {
  ...
  const result = {
    ...
    certidaoTipo: s.certidao_tipo,
    certidaoModelo: s.certidao_modelo,
    certidaoMatricula: s.certidao_matricula,
    certidaoTermo: s.certidao_termo,
    ...
    tituloEleitorDataEmissao: dateDbToBr(s.titulo_eleitor_data_emissao),
    tituloEleitorUf: s.titulo_eleitor_uf,
    ...
    situacaoEnsinoMedio: s.situacao_ensino_medio,
    serieEnsinoMedioAtual: s.serie_ensino_medio_atual,
    escolaEnsinoMedio: s.escola_ensino_medio,
    anoPrevisaoConclusaoEnsinoMedio: s.ano_previsto_conclusao_ensino_medio,
    anoPrevistoConclusaoEnsinoMedio: s.ano_previsto_conclusao_ensino_medio,
...
export function toSnake(c: any) {
  ...
  return {
    ...
    certidao_tipo: source.certidaoTipo || source.certidao_tipo || null,
    certidao_modelo: source.certidaoModelo || source.certidao_modelo || null,
    certidao_matricula: source.certidaoMatricula || source.certidao_matricula || null,
    ...
    titulo_eleitor_data_emissao: dateBrToDb(
      source.tituloEleitorDataEmissao || source.titulo_eleitor_data_emissao,
    ),
    titulo_eleitor_uf: source.tituloEleitorUf || source.titulo_eleitor_uf || null,
    ...
    situacao_ensino_medio: source.situacaoEnsinoMedio || null,
    serie_ensino_medio_atual: source.serieEnsinoMedioAtual || null,
    escola_ensino_medio: source.escolaEnsinoMedio || null,
    ano_previsto_conclusao_ensino_medio: source.anoPrevisaoConclusaoEnsinoMedio || source.anoPrevistoConclusaoEnsinoMedio || null,
