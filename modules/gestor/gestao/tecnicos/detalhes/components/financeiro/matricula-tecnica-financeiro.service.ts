...
import { createMatriculaTecnicaFinanceiroService } from './matricula-tecnica-financeiro.client';
...
const requirePreVinculoContexto = (value: unknown): PreVinculoAlunoTecnicoContexto => {
  ...
  requireMatriculaTecnicaCicloFinanceiroPolicy(value.turma.cicloFinanceiroTecnico);
...
const requireWorkspace = (value: unknown): MatriculaTecnicaFinanceiroWorkspace => {
  ...
  requireMatriculaTecnicaCicloFinanceiroPolicy(turma.cicloFinanceiroTecnico);
...
export const matriculaTecnicaFinanceiroService = createMatriculaTecnicaFinanceiroService({
  unwrap,
