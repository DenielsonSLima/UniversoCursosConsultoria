// File: modules/gestor/cadastros/modelos-documentos/irpf/components/IRPFList.tsx

import React, { useEffect, useState } from 'react';
import { Building2, ArrowRight, FileText, Settings } from 'lucide-react';
import { polosService } from '../../../../configuracoes/polos/polos.service';

interface IRPFListProps {
  onSelectPolo: (polo: any) => void;
  onConfigureQr: () => void;
  sharedTemplate?: boolean;
}

const IRPFList: React.FC<IRPFListProps> = ({ onSelectPolo, onConfigureQr, sharedTemplate = false }) => {
      ...
      <div className="animate-fadeIn">
        <div className="mb-8 flex flex-col md:flex-row justify-between items-end gap-4">
          <div>
              ...
              <p className="text-slate-500 text-sm">
                Um único modelo para todos os polos. Logo, endereço e dados institucionais mudam automaticamente conforme o polo da matrícula.
              </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <h4 className="text-lg font-black text-[#001a33] mb-1 group-hover:text-emerald-600 transition-colors">
              Declaração de IRPF
            </h4>
            ...
            <div className="pt-4 border-t border-slate-50 flex justify-between items-center">
              <span className="text-xs font-bold text-slate-400 uppercase tracking-wider group-hover:text-emerald-500 flex items-center gap-2">
    ...
    <div className="animate-fadeIn">
      <div className="mb-8 flex flex-col md:flex-row justify-between items-end gap-4">
        <div>
            ...
            <p className="text-slate-500 text-sm">Defina o modelo de declaração IRPF específico para cada polo.</p>
        </div>
