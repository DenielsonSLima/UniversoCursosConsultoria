...
const CarteirinhaCard: React.FC<CarteirinhaCardProps> = ({ modelo, onEdit, onDelete }) => {
  return (
    <div 
      className="bg-white rounded-3xl p-5 border border-slate-200 hover:border-pink-400 hover:shadow-lg transition-all group flex flex-col h-full animate-fadeIn cursor-pointer" 
