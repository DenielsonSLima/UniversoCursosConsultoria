...
const ModelosDocumentosPage: React.FC<ModelosDocumentosPageProps> = ({
  ...
  const models: Array<{
    ...
    { id: 'carteirinha-preceptor', title: 'Crachá de Preceptor', desc: 'Credencial própria para professores autorizados no polo.', icon: <BadgeCheck size={24} />, color: 'bg-cyan-700' },
