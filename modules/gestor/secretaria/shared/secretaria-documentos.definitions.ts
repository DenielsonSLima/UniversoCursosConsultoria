...
export const secretariaDocumentoDefinitions: Record<string, SecretariaDocumentoDefinition> = {
  ...
  crachaPeriodoEleitoral: {
    ...
    title: 'SES',
    description: 'Crachá SES liberado somente após a entrada do aluno no estágio.',
    singularLabel: 'Crachá SES',
    actionLabel: 'Preparar crachá',
    icon: Vote,
  ...
  transferencia: {
    id: 'transferencia',
    title: 'Transferência',
    description: 'Guia de transferência para estudante ativo ou já transferido de turma técnica.',
    ...
    technicalOnly: true,
    enrollmentStatuses: ['ATIVO', 'TRANSFERIDO'],
    activeTurmaOnly: true,
    allowBatch: false,
  },
};
