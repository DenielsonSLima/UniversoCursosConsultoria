...
-- Impede que uma busca textual sem dígitos transforme o filtro de CPF em LIKE '%%',
-- o que fazia a RPC retornar os primeiros alunos independentemente do termo digitado.
...
comment on function public.ead_buscar_alunos_disponiveis(uuid, text) is
  'Lista até 20 alunos ativos disponíveis para matrícula EAD, filtrados por nome, e-mail ou CPF e limitados ao escopo de escrita do gestor.';
