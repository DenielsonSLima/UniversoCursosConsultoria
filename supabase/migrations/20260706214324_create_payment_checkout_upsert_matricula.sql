...
GRANT EXECUTE ON FUNCTION public.payment_checkout_upsert_matricula(uuid, uuid, boolean) TO authenticated;
GRANT EXECUTE ON FUNCTION public.payment_checkout_upsert_matricula(uuid, uuid, boolean) TO service_role;

COMMENT ON FUNCTION public.payment_checkout_upsert_matricula(uuid, uuid, boolean)
IS 'Neutral checkout matricula upsert used by modular payment gateways.';
