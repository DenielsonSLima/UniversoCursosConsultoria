-- Full credited components use their academic credit, never fabricated diary entries.
-- Public wrapper authorization and non-credited closing requirements are unchanged.
begin;
