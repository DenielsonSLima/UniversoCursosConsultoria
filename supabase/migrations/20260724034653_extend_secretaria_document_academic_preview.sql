-- Mantém a fonte canônica de notas/frequência no backend e amplia a composição
-- para a declaração de frequência, respeitando a permissão do próprio documento.
