create function public.get_diario_historico_importado(p_turma_id uuid,p_disciplina_id uuid)
...
begin
  ...
  select jsonb_build_object(
    ...
    'students',coalesce((select jsonb_agg(jsonb_build_object(
      ...
      'resultState',case when r.resultado_documental is null or r.notas_estado <> 'CONFERIDO'
        or r.frequencia_estado <> 'CONFERIDO' then 'EM_CONFERENCIA' else 'CONFERIDO' end,
