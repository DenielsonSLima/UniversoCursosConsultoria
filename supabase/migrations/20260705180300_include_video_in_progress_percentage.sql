-- Include video in progress percentage calculation
...
begin
  ...
  v_total_done := least(v_content_done, v_content_total) + least(v_activity_done, v_activity_total) + least(v_video_done, v_video_total);
