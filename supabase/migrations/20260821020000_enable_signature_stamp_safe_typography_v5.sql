-- Libera somente tipografia segura no template global do carimbo.
-- Conteudo, bindings, rotulos probatorios, cores e snapshots historicos
-- permanecem imutaveis. Migrations anteriores nao sao reescritas.
...
BEGIN
  ...
  THEN
    RAISE EXCEPTION USING
      ERRCODE = '55000',
      MESSAGE = 'ASSINATURA_CARIMBO_TIPOGRAFIA_V5_CONTRATO_AUSENTE';
  END IF;
END;
$migration$;
...
BEGIN
  ...
  THEN
    RAISE EXCEPTION USING
      ERRCODE = '55000',
      MESSAGE = 'ASSINATURA_CARIMBO_TIPOGRAFIA_V5_VALIDADOR_DRIFT';
  END IF;
  ...
  IF v_occurrences <> 1 THEN
    RAISE EXCEPTION USING
      ERRCODE = '55000',
      MESSAGE = 'ASSINATURA_CARIMBO_TIPOGRAFIA_V5_SENTINELA_INVALIDO';
  END IF;
  ...
  THEN
    RAISE EXCEPTION USING
      ERRCODE = '55000',
      MESSAGE = 'ASSINATURA_CARIMBO_TIPOGRAFIA_V5_PATCH_INCOMPLETO';
  END IF;
  ...
  THEN
    RAISE EXCEPTION USING
      ERRCODE = '55000',
      MESSAGE = 'ASSINATURA_CARIMBO_TIPOGRAFIA_V5_ATRIBUTOS_ALTERADOS';
  END IF;
END;
$migration$;
...
BEGIN
  ...
  THEN
    RAISE EXCEPTION USING
      ERRCODE = '55000',
      MESSAGE = 'ASSINATURA_CARIMBO_TIPOGRAFIA_V5_DEFAULT_DRIFT';
  END IF;
  ...
  IF v_occurrences <> 1 THEN
    RAISE EXCEPTION USING
      ERRCODE = '55000',
      MESSAGE = 'ASSINATURA_CARIMBO_TIPOGRAFIA_V5_LABEL_DRIFT';
  END IF;
  ...
  THEN
    RAISE EXCEPTION USING
      ERRCODE = '55000',
      MESSAGE = 'ASSINATURA_CARIMBO_TIPOGRAFIA_V5_DEFAULT_INVALIDO';
  END IF;
END;
$migration$;
