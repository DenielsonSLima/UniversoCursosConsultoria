-- Evita uma folha final vazia na minuta completa quando o encerramento cabe
-- com segurança junto ao último bloco jurídico. Em páginas densas, a folha
-- exclusiva de assinaturas e QR continua sendo criada.
...
declare
  ...
  v_last_body text;
  -- Limite conservador validado contra a área que termina antes das
  -- assinaturas no compositor V3. O último bloco atual possui 473 caracteres.
  v_closing_safe_body_limit integer := 1200;
begin
